...
@section('title', 'Portofolio - Kevin Naufal Fernanda')
...
<div class="relative py-32 overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center mb-24">
            <h2 class="text-xs text-cyan-400 font-bold tracking-[0.2em] uppercase mb-4">Karya Pilihan</h2>
            <p class="text-4xl sm:text-6xl font-black text-white tracking-tight mb-6">Desain & Pengembangan</p>
            <p class="max-w-2xl text-xl text-slate-400 mx-auto font-light leading-relaxed">Koleksi proyek yang menonjolkan estetika desain futuristik dan fungsionalitas teknis.</p>
        </div>

        <!-- Category Navigation -->
        <div class="flex flex-wrap justify-center gap-4 mb-16">
            <a href="{{ url('/projects') }}" class="px-6 py-2 rounded-full bg-slate-100 text-slate-900 font-bold border border-white shadow-[0_0_20px_rgba(255,255,255,0.3)]">Semua</a>
            ...
            <div class="group bg-slate-900/50 rounded-3xl overflow-hidden shadow-lg hover:shadow-[0_0_50px_rgba(34,211,238,0.15)] transition-all duration-500 border border-slate-800 hover:border-cyan-500/50 flex flex-col backdrop-blur-sm">
                ...
                <div class="p-8 flex-1 flex flex-col relative">
                    ...
                    <a href="#" class="inline-flex items-center text-sm font-bold text-white group-hover:text-cyan-400 transition-colors uppercase tracking-wider">
                        Kunjungi Situs <svg class="w-4 h-4 ml-2 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </a>
                </div>
            </div>
        </div>
